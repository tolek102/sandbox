...
public class PersonApplicationJPA implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        logger.info("inserting id 10005 ->{}", repository.insert(
                new PersonJPA("InsertedName5JPA", "InsertedLocation5JPA", new Date(92, 02, 03), new Date())));

        logger.info("Update id 10003 ->{}", repository.update(new PersonJPA(10003, "Name3JPA changed", "Location3JPA changed", new Date(99, 03, 11), new Date())));
